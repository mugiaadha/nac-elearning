    ...
    <div style="max-width:480px;margin:100px auto 24px auto;padding:0 12px;">
        <div style="background:#fff;border-radius:18px;box-shadow:0 6px 32px rgba(30,64,175,0.10),0 1.5px 6px rgba(30,64,175,0.07);padding:36px 28px 28px 28px;">
            <div style="text-align:center;margin-bottom:28px;">
                ...
                <h2 style="margin:0;font-size:1.7rem;font-weight:700;color:#1e40af;letter-spacing:0.01em;">{{ $title ?? 'NAC Tax Center' }}</h2>
            </div>
            @yield('content')
        ...
        <div style="text-align:center;margin-top:18px;color:#a5b4fc;font-size:0.93rem;">Solusi Perpajakan Modern untuk Indonesia</div>
    </div>
</body>
