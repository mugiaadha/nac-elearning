...
@section('title')
{{ $category->category_name }} | NAC Tax Center
@endsection
<!-- ================================
    ...
    <div class="container">
        <div class="filter-bar mb-4">
            <div class="filter-bar-inner d-flex flex-wrap align-items-center justify-content-between">
                <p class="fs-14">Kita menemukan <span class="text-black">{{ count($courses) }}</span> modul pelatihan</p>
            ...
            <div class="col-lg-4">
                <div class="sidebar mb-5">
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-18 pb-2">Pencarian</h3>
                            <div class="divider"><span></span></div>
                            <form method="post">
                                <div class="form-group mb-0">
                                    <input class="form-control form--control pl-3" type="text" name="search" placeholder="Pencarian Pelatihan">
