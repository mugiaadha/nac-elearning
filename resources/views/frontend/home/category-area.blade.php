        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="category-btn-box text-right">
                    <a href="categories.html" class="btn theme-btn">Semua Kategori <i class="la la-arrow-right icon ml-1"></i></a>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 responsive-column-half">
                    <div class="category-item">
                        <img class="cat__img lazy" src="{{ asset($cat->image ?? 'backend/assets/images/errors-images/404-error.png') }}" data-src="{{ asset($cat->image) }}" alt="Category image">
