                        ...
                        <form method="POST" class="pt-4" action="{{ route('register') }}">
                            ...
                            <div class="btn-box">
                                <div class="custom-control custom-checkbox mb-2 fs-15">
                                    ...
                                    <label class="custom-control-label custom--control-label lh-20" for="receiveCheckbox">Yes! I want to get the most out of NAC Tax Center by receiving emails with exclusive deals, personal recommendations and learning tips!</label>
