  ...
  <ul class="generic-list-item off-canvas-menu-list off--canvas-menu-list pt-35px">
      ...
      <li><a href="{{ route('my.course') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
                  <path d="M0 0h24v24H0V0z" fill="none" />
      ...
      <li><a href="{{ route('live.chat') }}"><svg class="mr-2" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px">
                  <path d="M0 0h24v24H0V0z" fill="none" />
