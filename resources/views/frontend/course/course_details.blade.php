...
@section('title')
{{ $course->course_name }} | NAC Tax Center
@endsection
        ...
        <div class="row">
            <div class="col-lg-8 pb-5">
                <div class="course-details-content-wrap pt-90px">
                    ...
                    <div class="course-overview-card bg-gray p-4 rounded">
                        <h3 class="fs-16 font-weight-semi-bold">Curated for the <a href="for-business.html" class="text-color hover-underline">NAC Tax Center for Business</a> collection</h3>
                    </div><!-- end course-overview-card -->
                    ...
                    <div class="course-overview-card border border-gray p-4 rounded">
                        <h3 class="fs-20 font-weight-semi-bold">Top companies trust NAC Tax Center</h3>
                        <p class="fs-15 pb-1">Get your team access to NAC Tax Center's top 5,000+ courses</p>
                        <div class="pb-3">
                        ...
                        <a href="for-business.html" class="btn theme-btn theme-btn-sm">Try NAC Tax Center for Business</a>
                    </div><!-- end course-overview-card -->
                    <div class="course-overview-card">
            ...
            <div class="col-lg-4">
                <div class="sidebar sidebar-negative">
                            ...
                            <div class="preview-course-feature-content pt-40px">
                                ...
                                <div class="preview-course-incentives">
                                    ...
                                    <div class="buy-for-team-container pt-4">
                                        ...
                                        <p class="lh-24 pb-3">Get your team access to 3,000+ top NAC Tax Center courses anytime, anywhere.</p>
                                        <a href="for-business.html" class="btn theme-btn theme-btn-sm theme-btn-transparent lh-30 w-100">Try NAC Tax Center for Business</a>
                                    </div>
                    ...
                    <div class="card card-item">
                        <div class="card-body">
                            <h3 class="card-title fs-18 pb-2">Kategori Pelatihan</h3>
                            <div class="divider"><span></span></div>
                            <ul class="generic-list-item">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-3">
                <div class="cta-btn-box text-right">
                    <a href="become-a-teacher.html" class="btn theme-btn">Tech on NAC Tax Center <i class="la la-arrow-right icon ml-1"></i> </a>
                </div>
            </div><!-- end col-lg-3 -->
        </div><!-- end row -->
    </div><!-- end container -->
