        ...
        if (
            ...
            if (displayEventEnd && eventDef.hasEnd) {
                ...
                return dateEnv.format(segStart, timeFormat, {
                    forcedTzo: startOverride
                        ? null
                        : eventInstance.forcedStartTzo, // nooooo, same
                });
            }
        }
        return "";
        ...
        */
        ...
        EventApi.prototype.mutate = function (mutation) {
            ...
            if (instance) {
                ...
                this._instance =
                    relevantEvents_1.instances[instance.instanceId];
                context_1.dispatch({
                    type: "MERGE_EVENTS",
                    ...
                    if (
                        ...
                        buttonClick = function (ev) {
                            if (customButtonProps_1.click) {
                                customButtonProps_1.click.call(
                                    ev.target,
                                    ev,
                                    ev.target,
                                );
                        ...
                        return createElement(
                            ...
                            !props.forPrint &&
                                ...
                                morePopoverState.currentFgEventSegs ===
                                    props.fgEventSegs && // clear popover on event mod
