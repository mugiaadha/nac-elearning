!(function () {
    ...
    var e = Array.prototype.indexOf
        ...
        : function (d, $, t) {
              if (
                  ((t = null == t ? 0 : 0 > t ? Math.max(0, d.length + t) : t),
                  "string" == typeof d)
              )
    ...
    ((O.prototype.j = function () {
        ...
        (U.prototype.i = function (d, $) {
            ...
            if (14 == d.i)
                return "string" == typeof $ && D.test($) && 0 < (d = Number($))
                    ? d
                    : $;
            if (!d.u) return $;
            if ((d = d.v) === String) {
    ...
    function rd(d, $) {
        for (var t, e = new n(), r = d.length, i = 0; i < r; ++i)
            null != (t = $[(t = d.charAt(i)).toUpperCase()]) && e.g(t);
        return e.toString();
    }
    function id(d) {
    ...
    function ud(d, $, t) {
        ...
        d: {
            for (
                var r,
                    i = (d =
                        0 == y(d, 20).length || 2 == t ? y(d, 19) : y(d, 20))
                        .length,
                    u = 0;
                u < i;
                ++u
    ...
    function sd(d, $) {
        ...
        if (null == t) {
            ...
            ((t = new V().g(v.j(), t)), (d.g[$] = t));
        }
        return t;
    }
    function hd(d, $) {
        var t = d.length;
        return !(0 < T($, 9) && -1 == e(y($, 9), t)) && Ad(M($, 2), d);
    }
    function pd(d, $) {
        if (null == $) return null;
        var t = M($, 1);
    ...
    function Cd(d, $, t, n) {
        var i = fd(t, n),
            u = 0 == T(i, 9) ? y(m(t, 1), 9) : y(i, 9);
        if (((i = y(i, 10)), 2 == n)) {
            if (!ed(fd(t, 0))) return Cd(d, $, t, 1);
            ed((d = fd(t, 1))) &&
                (r((u = u.concat(0 == T(d, 9) ? y(m(t, 1), 9) : y(d, 9)))),
                0 == i.length ? (i = y(d, 10)) : r((i = i.concat(y(d, 10)))));
        }
        return -1 == u[0]
            ? 5
            : (($ = $.length),
    ...
    function Sd(d, $) {
        var t = ld($);
        return ($ = M($, 1)) in L ? Cd(d, t, ($ = od(d, $, cd($))), -1) : 1;
    }
    function md(d, $, t, e, r, i) {
        ...
        if (0 == o.length) u = 20;
            ...
            ((o = o.replace(w, "")), ($.i = ""), $.g(td(o)), (u = 1));
        else {
            if (
                ((o = new RegExp(u)), nd($), 0 == (u = $.toString()).search(o))
            ) {
                o = u.match(o)[0].length;
                var l = u.substring(o).match(W);
                l && null != l[1] && 0 < l[1].length && "0" == rd(l[1], H)
                    ? (u = !1)
                    : (($.i = ""), $.g(u.substring(o)), (u = !0));
            } else u = !1;
            u = u ? 5 : 20;
        }
        if ((r && A(i, 6, u), 20 != u)) {
            ...
            d: {
                if (0 != (d = $.toString()).length && "0" != d.charAt(0))
                    for (r = d.length, $ = 1; 3 >= $ && $ <= r; ++$)
                        if ((t = parseInt(d.substring(0, $), 10)) in L) {
                            (e.g(d.substring($)), (e = t));
                            break d;
                        }
                e = 0;
        ...
        return null != t &&
            ((o = "" + (u = M(t, 10))),
            0 == (l = $.toString()).lastIndexOf(o, 0) &&
                ((o = new n(l.substring(o.length))),
                (l = m(t, 1)),
                (l = new RegExp(M(l, 2))),
                Md(o, t, null),
                (o = o.toString()),
                (!Ad(l, $.toString()) && Ad(l, o)) ||
                    3 == Cd(d, $.toString(), t, -1)))
            ? (e.g(o), r && A(i, 6, 10), A(i, 1, u), u)
            : (A(i, 1, 0), 0);
    }
    function Md(d, $, t) {
        var n = d.toString(),
        ...
        if (0 != e && null != r && 0 != r.length) {
            var i = new RegExp("^(?:" + r + ")");
            if ((e = i.exec(n))) {
                var u = Ad((r = new RegExp(M(m($, 1), 2))), n),
                    o = e.length - 1;
                null == ($ = m($, 16)) ||
                0 == $.length ||
                null == e[o] ||
                0 == e[o].length
                    ? (u && !Ad(r, n.substring(e[0].length))) ||
                      (null != t && 0 < o && null != e[o] && t.g(e[1]),
                      d.set(n.substring(e[0].length)))
                    : ((n = n.replace(i, $)),
                      (!u || Ad(r, n)) &&
                          (null != t && 0 < o && t.g(e[1]), d.set(n)));
            }
        }
    }
    function yd(d, $, t) {
        if (!id(t) && 0 < $.length && "+" != $.charAt(0))
            throw Error("Invalid country calling code");
        return Td(d, $, t, !0);
    }
    function Td(d, $, t, e) {
        ...
        if (0 <= i) {
            ...
            ((i = r.g),
                0 <= (u = $.search(Y))
                    ? 0 <=
                          (o = (u = (u = $.substring(u)).replace(j, "")).search(
                              J,
                          )) && (u = u.substring(0, o))
                    : (u = ""),
                i.call(r, u));
        if (
            (0 < (u = (i = r.toString()).indexOf(";isub=")) &&
                ((r.i = ""), r.g(i.substring(0, u))),
            !$d(r.toString()))
        )
            throw Error(
                "The string supplied did not seem to be a phone number",
        ...
        if (
            ((i = r.toString()),
            !(id(t) || (null != i && 0 < i.length && w.test(i))))
        )
            throw Error("Invalid country calling code");
        ((i = new O()), e && A(i, 5, $));
        d: {
            if (
                0 <= (u = ($ = r.toString()).search(z)) &&
                $d($.substring(0, u))
            )
        ...
        try {
            ...
            if ("Invalid country calling code" != t.message || !w.test(l))
                throw t;
            if (0 == (o = md(d, (l = l.replace(w, "")), u, $, e, i))) throw t;
        }
        if (
            (0 != o
                ? (r = cd(o)) != t && (u = od(d, o, r))
                : (nd(r),
                  ...
                  null != t
                      ? A(i, 1, (o = M(u, 10)))
                      : e && (delete i.g[6], i.i && delete i.i[6])),
            2 > $.i.length)
        )
            throw Error(
        ...
        if (
            (null != u &&
                ((t = new n()),
                Md((r = new n($.toString())), u, t),
                2 != (d = Cd(d, r.toString(), u, -1)) &&
                    4 != d &&
                    5 != d &&
                    (($ = r),
                    e && 0 < t.toString().length && A(i, 7, t.toString()))),
        ...
        if (1 < e.length && "0" == e.charAt(0)) {
            for (A(i, 4, !0), d = 1; d < e.length - 1 && "0" == e.charAt(d); )
                d++;
            1 != d && A(i, 8, d);
        }
        ...
        $("intlTelInputUtils.formatNumber", function (d, $, t) {
            try {
                var n = x.g(),
                    e = yd(n, d, $),
                    r = Sd(n, e);
                return 0 == r || 4 == r ? ud(n, e, void 0 === t ? 0 : t) : d;
            } catch ($) {
                return d;
            }
        }),
