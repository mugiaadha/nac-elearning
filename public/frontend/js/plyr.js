    ...
    (function (e, t) {
        ...
        var te,
            ...
            ie = {
                ...
                mime: function (e) {
                    ...
                    Object.keys(ne).includes(n) &&
                        (n += '; codecs="'.concat(ne[e], '"'));
                    try {
                        return Boolean(
        ...
        var Ae = {
                ...
                return (
                    s.toggle
                        ? (r.appendChild(
                          ...
                          r.appendChild(
                              Ae.createIcon.call(this, s.icon, {
            ...
            bindMenuItemShortcuts: function (e, t) {
                ...
                (O(
                    ...
                    O(e, "keyup", function (e) {
                        13 === e.which &&
                            Ae.focusFirstMenuItem.call(n, null, !0);
                    }));
            },
            ...
            timeUpdate: function (e) {
                var t =
                    !N.element(this.elements.display.duration) &&
            ...
            toggleMenu: function (e) {
                ...
                if (N.element(t) && N.element(n)) {
                    ...
                    if (N.boolean(e)) a = e;
                        ...
                        var s = N.function(e.composedPath)
                                ? e.composedPath()[0]
                                : e.target,
                            r = t.contains(s);
            ...
            create: function (e) {
                ...
                return (
                    ...
                    this.isHTML5 &&
                        o.call(this, le.getQualityOptions.call(this)),
                    l.call(this),
                    u
                );
            },
            inject: function () {
                ...
                (N.function(this.config.controls) &&
                    ...
                    N.element(this.config.controls) ||
                        ...
                        if (N.element(this.elements.captions))
                            if (N.nullOrUndefined(e) || Array.isArray(e)) {
                                ...
                                if (i !== this.elements.captions.innerHTML) {
                                    ...
                                    var a = B(
                                        "span",
                                        Y(this.config.selectors.caption),
                                    );
                                    ((a.innerHTML = i),
        ...
        var Fe = {
                ...
                setTitle: function () {
                    ...
                    if (
                        ...
                        var n = N.empty(this.config.title)
                                ? "video"
                                : this.config.title,
                            ...
                            value: function () {
                                ...
                                (this.bind(
                                    ...
                                    this.bind(
                                        ...
                                        function (e) {
                                            return Ae.updateSeekTooltip.call(
                                                t,
                                                e,
                                            );
                                        },
                                    ...
                                    L.isWebkit &&
                                        Array.from(
                                            G.call(t, 'input[type="range"]'),
                                        ).forEach(function (n) {
                                            e.bind(n, "input", function (e) {
                                                return Ae.updateRangeFill.call(
                                                    t,
                                                    e.target,
                                                );
                                            });
        ...
        var We = {
            ...
            ready: function () {
                ...
                (u.appendChild(l),
                    (t.media = K(u, t.media)),
                    ve(ue(t.config.urls.vimeo.api, o), "json").then(
                        function (e) {
                            if (!N.empty(e)) {
                ...
                setup: function () {
                    ...
                    if (
                        ...
                        ((window.onYouTubeIframeAPIReady = function () {
                            ...
                            Be(this.config.urls.youtube.sdk).catch(
                                function (t) {
                                    e.debug.warn(
                    ...
                    n(t, [
                        {
                            ...
                            value: function () {
                                var e = this;
                                this.enabled &&
                                    (N.object(window.google) &&
                                    N.object(window.google.ima)
                                        ? this.ready()
                                        : Be(
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ((this.elements.thumb.container = B("div", {
                                    ...
                                    (this.elements.thumb.imageContainer = B(
                                        "div",
                                        {
                                            class: this.player.config.classNames
                                                .previewThumbnails
                                ...
                                ((this.elements.thumb.time = B(
                                    ...
                                    (this.elements.scrubbing.container = B(
                                        "div",
                                        {
                                            class: this.player.config.classNames
                                                .previewThumbnails
        ...
        return (
            (Ze.defaults = ((Ge = Ne), JSON.parse(JSON.stringify(Ge)))),
            Ze
        );
    });
