            ...
            function st(t) {
                for (var n = 0; n < f.length; n++) {
                    if (u[f[n].name] && f[n].emphasis && f[n].tag != "")
                        it(f[n].tag)
                            ? p
                                  .find("." + u.css + "_tool_" + f[n].cls)
                                  .addClass(m)
                            : e("." + u.css + "_tool_" + f[n].cls).removeClass(
                                  m,
                              );
                }
            ...
            for (var T = 0; T < f.length; T++) {
                if (u[f[T].name]) {
                    ...
                    if (f[T].name == "format" && e.isArray(u.formats)) {
                        var k =
                            u.formats[0][1].length > 0 &&
                            u.formats[0][1] != "undefined"
                                ? u.formats[0][1]
                                : "";
                ...
                .click(function (t) {
                    if (
                        ...
                        if (!p.data("sourceOpened")) {
                            ...
                            p.find("." + u.css + "_tool").removeClass(
                                u.css + "_hiddenField",
                            );
                            x.addClass(u.css + "_hiddenField");
                            v.removeClass(u.css + "_hiddenField");
                ...
                .keydown(function (e) {
                    if (e.ctrlKey) {
                        for (var t = 0; t < f.length; t++) {
                            if (
                                u[f[t].name] &&
                                e.keyCode == f[t].key.charCodeAt(0)
                            ) {
                                if (
                                    f[t].command != "" &&
