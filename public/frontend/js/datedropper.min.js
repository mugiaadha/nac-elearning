    ...
    (function (u) {
        var p = {},
            ...
            l = {
                init: function (r) {
                    return (
                        u(this).each(function () {
                            r &&
                                r.roundtrip &&
                                !u(this).attr("data-dd-roundtrip") &&
                                u(this).attr("data-dd-roundtrip", r.roundtrip);
                        }),
                        u(this).each(function () {
                            if (!u(this).hasClass("picker-trigger")) {
                                var e = u(this),
                                    i = "datedropper-" + Object.keys(p).length;
                                e.attr("data-datedropper-id", i).addClass(
                                    "picker-trigger",
                                );
                                var t = {
                                    identifier: i,
                ...
                destroy: function (i) {
                    return u(this).each(function () {
                        var e = S(u(this));
                        e &&
                            (o && e.identifier == o.identifier && B(o),
                            u(this)
            ...
            b = function (e) {
                e.fx &&
                    !e.fxMobile &&
                    (u(window).width() < 480
                        ? e.element.removeClass("picker-fxs")
                        : e.element.addClass("picker-fxs"));
            },
            g = function (e) {
                return e % 1 == 0 && e;
            },
        ...
        var y = function (e) {
            ...
            w = function (r, e) {
                ...
                if (
                    (a &&
                        u.each(a, function (e, i) {
                            ...
                            t.m == x(r, "m") &&
                                ...
                                A(
                                    r,
                                    ".pick-lg-b li.pick-v[data-value=" +
                                        t.d +
                                        "]",
                                ).addClass("pick-sl pick-sl-" + e);
                        }),
                    ...
                    (i = {
                        ...
                        b: n.length
                            ? A(r, ".pick-lg-b li").index(n) - 1
                            : A(r, ".pick-lg-b li").last().index(),
                    }),
                    ...
                    e
                        ? ((t = L(
                          ...
                          a.a.value == a.b.value && t > a.a.value && (p = !0))
                        : ((t = L(x(r))),
                          ((t >= a.a.value && t <= a.b.value) || o.length) &&
                              (p = !0)),
                    s &&
                        A(r, ".pick-lg-b li").removeClass(
            ...
            z = function (e, i, t) {
                var r = e.key[i];
                return t > r.max
                    ? z(e, i, t - r.max + (r.min - 1))
                    : t < r.min
                      ? z(e, i, t + 1 + (r.max - r.min))
                      : t;
            },
            T = function (e) {
            ...
            j = function (e, i) {
                var t = !1;
                for (var r in (("Y" != e.format && "m" != e.format) ||
                    ((e.hideDay = !0),
                ...
                (e.hideMonth ||
                    e.hideDay ||
                    e.hideYear ||
                    e.showOnlyEnabledDays) &&
                    ((e.largeOnly = !1), (e.large = !1), (e.largeDefault = !1)),
                (e.element = u("<div>", {
                    class:
                        "datedropper " +
                        (t ? "picker-clean" : "") +
                        " " +
                        (e.modal ? "picker-modal" : "") +
                        " " +
                        e.theme +
                        " " +
                        (e.fx ? "picker-fxs" : "") +
                        " " +
                        (e.large && e.largeDefault ? "picker-lg" : ""),
                    id: e.identifier,
                ...
                (e.large &&
                    u("<div>", { class: "pick-lg" }).insertBefore(
                        A(e, ".pick-d"),
                    ),
                    u("<div>", { class: "pick-btns" }).appendTo(
                        A(e, ".picker"),
                    ),
                    u("<div>", {
                        tabindex: 0,
                    ...
                    setTimeout(function () {
                        (e.element.addClass("picker-focused"),
                            ...
                            e.element.hasClass("picker-modal") &&
                                (e.overlay = u(
            ...
            J = function (e, i) {
                ...
                var t = i.d,
                    ...
                    n = {
                        F: u.dateDropperSetup.languages[e.lang].months.full[
                            r - 1
                        ],
                        M: u.dateDropperSetup.languages[e.lang].months.short[
                            r - 1
                        ],
                        D: u.dateDropperSetup.languages[e.lang].weekdays.full[
                            o
                        ].substr(0, 3),
                        l: u.dateDropperSetup.languages[e.lang].weekdays.full[
                            o
                        ],
                        d: O(t),
                        m: O(r),
            ...
            X = function (e) {
                e.large &&
                    (e.element
                        .addClass("picker-transit")
                        .toggleClass("picker-lg"),
            ...
            R = function (a) {
                if (
                    ...
                    a.key.y.current > a.key.y.max &&
                        (a.key.y.current = a.key.y.max),
                    a.key.y.current < a.key.y.min &&
                        (a.key.y.current = a.key.y.min),
                    a.minDate)
                ) {
                    ...
                    (e
                        ? e < i && (a.defaultDate = a.minDate)
                        : (a.defaultDate = a.minDate),
                        Q(a, P(L(a.defaultDate))));
                }
                if (
                    ((a.disabledDays = a.disabledDays
                        ? a.disabledDays.split(",")
                        : null),
                    (a.enabledDays = a.enabledDays
                        ? a.enabledDays.split(",")
                        : null),
                    a.disabledDays &&
                    ...
                    var t =
                        (e = !!a.defaultDate && L(a.defaultDate)) &&
                        a.enabledDays.includes(e)
                            ? P(e)
                            : P(a.enabledDays[0]);
                    u.each(t, function (e, i) {
                        a.key[e].current = i;
                    ...
                    1 < r.length
                        ? r.each(function () {
                              var e = 0 == r.index(u(this)) ? "a" : "b",
                                  i = u(this).attr(
                                      "data-dd-roundtrip-default-" + e,
                                  ),
                                  t = i ? L(i) : o;
                              t && u(this).attr("data-dd-roundtrip-" + e, t);
                          })
                        : u.each(["a", "b"], function (e, i) {
                              var t = a.selector.attr(
                                      "data-dd-roundtrip-default-" + i,
                                  ),
                                  r = t ? L(t) : o;
                ...
                if (
                    ...
                    s &&
                        ...
                        a.key.y.current > a.key.y.max &&
                            (a.key.y.max = a.key.y.current),
                        a.key.y.current < a.key.y.min &&
                            (a.key.y.min = a.key.y.current));
                }
            },
            V = function (e, i) {
                e.element &&
                    (e.element.remove(), e.overlay && e.overlay.remove(), j(e));
            },
            H = function (e, i) {
                o && B(o);
                var t = S(e);
            ...
            B = function (e) {
                ...
                (i.element &&
                    ...
                    setTimeout(function () {
                        (i.element.remove(),
                            i.overlay &&
                                i.overlay.addClass("picker-overlay-hidden"));
                    }, 400)),
                    (o = null));
            },
            G = function (e) {
                if (e) {
                    ...
                    return (
                        ...
                        e.disabledDays &&
                            !e.enabledDays &&
                            (r = -1 != e.disabledDays.indexOf(i)),
                        e.enabledDays &&
                            !e.disabledDays &&
                            (r = -1 == e.enabledDays.indexOf(i)),
                        r
                            ? (Z(e), e.element.addClass("picker-locked"), !0)
            ...
            K = function (e, t) {
                ...
                for (r.empty(), i = a.min; i <= a.max; i++) {
                    ...
                    ("m" == t &&
                        (o =
                            u.dateDropperSetup.languages[e.lang].months.short[
                                i - 1
                            ]),
                        (o += "d" == t ? "<span></span>" : ""),
                        u("<li>", {
            ...
            q = function (r) {
                ...
                for (
                    ...
                    u("<li>", {
                        html:
                            "<div>" +
                            u.dateDropperSetup.languages[r.lang].weekdays.short[
                                e[i]
                            ] +
                            "</div>",
                    }).appendTo(A(r, ".pick-lg .pick-lg-h"));
                for (i = 0; i < 42; i++)
                    u("<li>", { html: u("<div>") }).appendTo(
                        A(r, ".pick-lg .pick-lg-b"),
                    );
                var t = 0,
                    a = A(r, ".pick-lg-b"),
                ...
                if (
                            ...
                            ? x(r, "y") <= D(r, "y") &&
                              (x(r, "m") == D(r, "m")
                                  ? A(
                                        ...
                                        .addClass("pick-lk")
                                  : x(r, "m") < D(r, "m")
                                    ? A(r, ".pick-lg .pick-lg-b li").addClass(
                                          "pick-lk",
                                      )
                                    : x(r, "m") > D(r, "m") &&
                                      x(r, "y") < D(r, "y") &&
                    ...
                    if (l)
                        if (x(r, "y") == l.y && x(r, "m") == l.m)
                            ...
                            L(r.maxDate) < L(x(r)) &&
                                A(r, ".pick-lg .pick-lg-b li.pick-v").addClass(
                                    "pick-lk",
                                );
                }
                if (r.minDate) {
            ...
            W = function (e, i) {
                ...
                (e.element.hasClass("picker-lg") && q(e),
                    ...
                    x(t, "d") > t.key.d.max &&
                        ((t.key.d.current = t.key.d.max), U(t, "d", x(t, "d"))),
                    A(t, ".pick-d li")
                        .removeClass("pick-wke")
                        .each(function () {
                            var e = new Date(
                                r + "/" + u(this).attr("value") + "/" + a,
                            ).getDay();
                            (u(this)
                                .find("span")
                                .html(
                                    u.dateDropperSetup.languages[t.lang]
                                        .weekdays.full[e],
                                ),
                                (0 != e && 6 != e) ||
                                    u(this).addClass("pick-wke"));
                        }),
                    t.element.hasClass("picker-lg") &&
                        (A(t, ".pick-lg-b li").removeClass("pick-wke"),
                        A(t, ".pick-lg-b li.pick-v").each(function () {
                            var e = new Date(
                                r + "/" + u(this).attr("data-value") + "/" + a,
                            ).getDay();
            ...
            U = function (e, i, t) {
                ...
                t == M(e, i, "last")) &&
                    ((r = a.find('li[value="' + M(e, i, "first") + '"]'))
                        .clone()
                        .insertAfter(a.find("li[value=" + t + "]")),
                    r.remove());
                t == M(e, i, "first") &&
                    ((r = a.find('li[value="' + M(e, i, "last") + '"]'))
                        .clone()
                        .insertBefore(a.find("li[value=" + t + "]")),
                    r.remove());
            ...
            _ = function (e, i, t) {
                var r = e.key[i];
                (t > r.max &&
                    ("d" == i && e.autoIncrease && $(e, "m", "right"),
                    "m" == i && e.autoIncrease && $(e, "y", "right"),
                    (t = r.min)),
                    t < r.min &&
                        ("d" == i && e.autoIncrease && $(e, "m", "left"),
            ...
            ee = function (o, e) {
                    ...
                    if (t) {
                        if (
                            ...
                            u.each(t, function (e, i) {
                                ...
                                (o.identifier != t &&
                                    p[t] &&
                                    ((p[t].key.m.current = r.m),
                                    (p[t].key.d.current = r.d),
                                    (p[t].key.y.current = r.y)),
                                    i.selector.is("input") &&
                                        i.selector.val(a.formatted).change());
                            });
                        else {
                ...
                if (i) {
                    var n = J(o);
                    (o.selector.is("input") &&
                        o.selector.val(n.formatted).change(),
        ...
        (u(document)
            .on("keydown", function (e) {
                ...
                if (o && !f())
                    if (32 == i) (A(o, ":focus").click(), e.preventDefault());
                        ...
                        u(e.target).is(".pick-m") &&
                            (e.preventDefault(),
                            u(".datedropper .pick-submit").focus());
                    else if (9 == i)
                        u(e.target).is(".pick-submit") &&
                            (e.preventDefault(),
            ...
            .on("click", function (e) {
                o &&
                    (o.selector.is(e.target) ||
                        o.element.is(e.target) ||
                        0 !== o.element.has(e.target).length ||
                        (B(o), (a = null)));
            })
            ...
            .on(v.i, F + " .pick-lg li.pick-v", function () {
                if (o) {
                    if (
                        (A(o, ".pick-lg-b li").removeClass("pick-sl"),
                        ...
                        if (i) {
                            ...
                            ("b" == r && t <= i.a.value && (r = "a"),
                                "a" == r
                                    ? u.each(i, function (e) {
                                          i[e].selector
                                              .attr("data-dd-roundtrip-" + e, t)
                                              .attr(
                                                  "data-dd-roundtrip-selector",
                                                  r,
                                              );
                                      })
                                    : i[r].selector
                                          .attr("data-dd-roundtrip-" + r, t)
                                          .attr(
                                              "data-dd-roundtrip-selector",
                                              r,
                                          ),
            ...
            .on(v.i, F + " .pick-arw.pick-arw-s2", function (e) {
                if (o) {
                    ...
                    var t = o.jump;
                    i = u(this).hasClass("pick-arw-r")
                        ? x(o, "y") + t
                        : x(o, "y") - t;
                    var r = (function (e, i, t) {
                        for (
                            var r = [], a = e.key[i], o = a.min;
                            o <= a.max;
                            o++
                        )
                            o % t == 0 && r.push(o);
            ...
            .on(v.m, function (e) {
                if (o && ((k = !1), a)) {
                    ...
                    (r != o.key[i].current && _(o, i, r),
                        o.onPickerDragging &&
                            o.onPickerDragging({ key: i, value: r }));
                }
            })
            .on(v.e, function (e) {
                a &&
                    ((d = n = a = null),
                    o && (W(o), o.onPickerRelease && o.onPickerRelease(J(o))));
            })
            ...
            document.addEventListener(
                ...
                function (e) {
                    ...
                    o && !i
                        ? (u("html,body").css("touch-action", "none"),
                          e.preventDefault())
                        : u("html,body").css("touch-action", "unset");
                },
                { passive: !1 },
            ),
            (u.fn.dateDropper = function (e) {
                if (m() && m() < 10)
                    console.error(
                        "[DATEDROPPER] This browser is not supported",
                    );
                else {
            ...
            u("head").append(
                "<style>" + u.dateDropperSetup.inlineCSS + "</style>",
            ),
