            ...
            (n.extend(g.prototype, {
                    ...
                    (n.each(i, function (t, e) {
                        ...
                        (n.isPlainObject(e)
                            ...
                            "function" === n.type(l.opts.caption) &&
                                (l.opts.caption = l.opts.caption.apply(e, [
                                    o,
                                    l,
                                ])),
                            "function" === n.type(o.opts.caption) &&
                                (l.opts.caption = o.opts.caption.apply(e, [
                                    o,
                                    l,
                                ])),
                ...
                addEvents: function () {
                    ...
                    (e.removeEvents(),
                        ...
                        c.on("keydown.fb", function (t) {
                            var o = (
                                    n.fancybox ? n.fancybox.getInstance() : null
                                ).current,
                                i = t.keyCode || t.which;
                            if (9 != i) {
                                if (
                ...
                scaleToActual: function (t, e, o) {
                    ...
                    l.isAnimating ||
                        ...
                        (t = void 0 === t ? 0.5 * u : t),
                        (e = void 0 === e ? 0.5 * f : e),
                        ((i = n.fancybox.getTranslate(d)).top -=
                            n.fancybox.getTranslate(h.$slide).top),
                ...
                isScaledDown: function (t, e) {
                    ...
                    return (
                        void 0 !== t && void 0 !== e
                            ...
                            : s &&
                              (o =
                                  (o = n.fancybox.getTranslate(s)).width <
                        ...
                        !1 === d.trigger("beforeClose", t)
                            ...
                            : (d.removeEvents(),
                              ...
                              "zoom" === o
                                  ? (n.fancybox.stop(s),
                                    (c = {
                                        top: (a = n.fancybox.getTranslate(s))
                                            .top,
                                        left: a.left,
                ...
                updateControls: function () {
                    ...
                    (t.$slide.trigger("refresh"),
                        ...
                        i
                            ...
                            .prop(
                                "disabled",
                                !t.opts.loop && o >= this.group.length - 1,
                            ),
                        "image" === t.type
                            ? i
        ...
        ((l.prototype.destroy = function () {
                ...
                if (
                    ...
                    ((this.realPoints = this.startPoints = s(o)),
                        this.startPoints.length &&
                            ...
                            (this.stagePos = n.fancybox.getTranslate(
                                l.$refs.stage,
                            )),
                    ...
                    if (
                        ...
                        r.group.length < 2 && a.opts.vertical
                            ...
                            : r.isDragging ||
                              ...
                              : ((s = Math.abs(
                                    (180 *
                                        Math.atan2(a.distanceY, a.distanceX)) /
                                        Math.PI,
                                )),
            ...
            (l.prototype.limitMovement = function () {
                ...
                return (
                    ...
                    c > 0 &&
                        i > t &&
                        (i = t - 1 + Math.pow(-t + d + c, 0.8) || 0),
                    c < 0 &&
                        i < n &&
                        (i = n + 1 - Math.pow(n - d - c, 0.8) || 0),
                    l > 0 &&
                        s > e &&
                        (s = e - 1 + Math.pow(-e + u + l, 0.8) || 0),
                    l < 0 &&
                        s < o &&
                        (s = o + 1 - Math.pow(o - u - l, 0.8) || 0),
                    { top: s, left: i }
                );
            }),
            ...
            (l.prototype.ontouchend = function (t) {
                ...
                if (
                    ...
                    e.removeEventListener("scroll", this.onscroll, !0),
                    this.requestId &&
                        (i(this.requestId), (this.requestId = null)),
                    (this.isSwiping = !1),
                    (this.isPanning = !1),
                    (this.isZooming = !1),
                    (this.isScrolling = !1),
            ...
            (l.prototype.endPanning = function () {
                ...
                this.contentLastPos &&
                    (!1 === this.opts.momentum || this.dMs > 350
                        ...
                        : ((t =
                              this.contentLastPos.left + 500 * this.velocityX),
            ...
            (l.prototype.onTap = function (e) {
                ...
                if (
                    ...
                    if (
                        ...
                        if (
                            !r.current.$content ||
                            !r.current.$content.find(a).addBack().filter(a)
                                .length
                        )
                            return;
                        o = "Content";
                    ...
                    if (i.tapped) {
                        if (
                            ...
                            (i.tapped = null),
                            Math.abs(h - i.tapX) > 50 ||
                                Math.abs(d - i.tapY) > 50)
                        )
                            return this;
                        u("dblclick" + o);
                    } else
        ...
        (e.extend(n.prototype, {
            ...
            clear: function () {
                (clearTimeout(this.timer),
                    (this.timer = null),
                    this.$progress &&
                        this.$progress.removeAttr("style").hide());
            },
            start: function () {
            ...
            focus: function (t) {
                ...
                this.instance.current &&
                    ...
                    (n.top < 0 || n.top > o.height() - e.outerHeight())
                        ? o
                              .stop()
                              .animate({ scrollTop: o.scrollTop() + n.top }, t)
                        : "x" === this.opts.axis &&
                          (n.left < i.scrollLeft() ||
                              n.left >
                                  i.scrollLeft() +
                ...
                a &&
                    ...
                    (n = a.opts.share.tpl
                        ...
                        .replace(
                            /\{\{descr\}\}/g,
                            s.$caption
                                ? encodeURIComponent(s.$caption.text())
                                : "",
                        )),
                    e.fancybox.open({
                        src: s.translate(s, n),
